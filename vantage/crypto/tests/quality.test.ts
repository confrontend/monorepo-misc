...
test('data quality links GMGN signals to cohort tokens without dropping unmatched observations', () => {
  ...
  try {
    ...
    storeGmgnSignal(database, {
      observed_at: '2026-08-09T01:00:00Z', token_address: 'MatchedToken', signal_type: 'buy',
    }, { capturedAt: new Date('2026-08-09T01:00:01Z'), logger: { warn() {} } });
    storeGmgnSignal(database, {
      observed_at: '2026-08-09T02:00:00Z', token_address: 'OutsideCohort', signal_type: 'watch',
    }, { capturedAt: new Date('2026-08-09T02:00:01Z'), logger: { warn() {} } });
    storeGmgnSignal(database, { signal_type: 'malformed' }, {
      capturedAt: new Date('2026-08-09T03:00:00Z'), logger: { warn() {} },
    });
